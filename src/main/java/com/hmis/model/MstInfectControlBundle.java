...
@Entity(name = "mst_infect_control_bundle")
public class MstInfectControlBundle {
	@Id
	...
	public MstInfectControlBundle() {
		super();
		// TODO Auto-generated constructor stub
	}

	public MstInfectControlBundle(Integer id, Integer mst_infect_control_devices_id, String bundle_name) {
		super();
		this.id = id;
